                        ...
                        <tr>
                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                <div class="flex items-center">
                                  ...
                                  <div class="ml-4">
                                    <div class="font-medium text-indigo-900 hover:text-indigo-600">quote</div>
                                  </div>
                                </div>
                              </td>
                          <td class="relative whitespace-nowrap py-4 pl-3  text-right text-sm font-medium sm:pr-6">
                            <a href="#" class="text-indigo-900 hover:text-indigo-600">Edit</a>
                          </td>
                          <td class="relative whitespace-nowrap py-4  pr-4 text-right text-sm font-medium sm:pr-6">
                            <a href="#" class="text-indigo-900 hover:text-indigo-600">Delete</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
